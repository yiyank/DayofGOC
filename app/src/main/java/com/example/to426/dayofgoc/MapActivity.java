...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //default screen always at Ross Business School
        moveCamera(new LatLng(42.27274265, -83.73754161923732),DEFAULT_ZOOM,"My Location");
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                if (!TextUtils.isEmpty(description)) {
                    ...
                    if (Linkify.addLinks(span, Linkify.WEB_URLS)) {
                        ...
                        Uri uriUrl = Uri.parse(placeInfo.getWebsiteUri().toString());
